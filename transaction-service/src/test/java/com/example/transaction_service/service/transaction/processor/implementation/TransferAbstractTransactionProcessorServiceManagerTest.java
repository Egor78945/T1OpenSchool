...
public class TransferAbstractTransactionProcessorServiceManagerTest {
    @Mock
    ...
    @InjectMocks
    private TransferAbstractTransactionProcessorServiceManager transferAbstractTransactionProcessorServiceManager;
    ...
    public void process_getUnknownProcessor_throwsNullPointerException() {
        Assertions.assertThrows(NullPointerException.class, () -> transferAbstractTransactionProcessorServiceManager.process(cancelledTransaction));
    }

    @Test
    public void accept_notAcceptedTransactionStatus_throwsProcessingException() {
        Assertions.assertThrows(ProcessingException.class, () -> transferAbstractTransactionProcessorServiceManager.accept(cancelledTransaction));
    }
    ...
    public void accept_transactionIsNotExists_throwsProcessingException() {
        ...
        Assertions.assertThrows(ProcessingException.class, () -> transferAbstractTransactionProcessorServiceManager.accept(acceptedTransaction));
    }
    ...
    public void accept_acceptTransaction_success() {
        ...
        Assertions.assertDoesNotThrow(() -> transferAbstractTransactionProcessorServiceManager.accept(acceptedTransaction));
    }

    @Test
    public void block_notBlockedTransactionStatus_throwsProcessingException() {
        Assertions.assertThrows(ProcessingException.class, () -> transferAbstractTransactionProcessorServiceManager.block(cancelledTransaction));
    }
    ...
    public void block_blockTransaction_success() {
        ...
        Mockito.when(accountService.update(blockTransaction.getSender())).thenReturn(blockTransaction.getSender());
        Mockito.when(transactionService.update(blockTransaction)).thenReturn(blockTransaction);
        Assertions.assertDoesNotThrow(() -> transferAbstractTransactionProcessorServiceManager.block(blockTransaction));
    }

    @Test
    public void reject_notRejectedTransactionStatus_throwsProcessingException() {
        Assertions.assertThrows(ProcessingException.class, () -> transferAbstractTransactionProcessorServiceManager.reject(cancelledTransaction));
    }

    @Test
    public void reject_rejectTransaction_success() {
        Mockito.when(accountService.update(rejectTransaction.getSender())).thenReturn(rejectTransaction.getSender());
        ...
        Assertions.assertDoesNotThrow(() -> transferAbstractTransactionProcessorServiceManager.reject(rejectTransaction));
    }
}
