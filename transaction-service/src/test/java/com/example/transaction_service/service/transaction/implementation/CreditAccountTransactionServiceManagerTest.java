...
public class CreditAccountTransactionServiceManagerTest {
    @Mock
    ...
    @InjectMocks
    private CreditAccountTransactionServiceManager creditAccountTransactionServiceManager;
    ...
    public void insert_invalidTransaction_recipientUserIdNotEqualToContextUserId_throwsTransactionException(){
        ...
        Assertions.assertThrows(TransactionException.class, () -> creditAccountTransactionServiceManager.insert(insertTransaction));
    }
    ...
    public void insert_validTransaction_success(){
        ...
        Assertions.assertNull(creditAccountTransactionServiceManager.insert(insertTransaction));
    }
    ...
    public void transfer_invalidTransaction_senderUserIdNotEqualToContextUserId_throwsTransactionException(){
        ...
        contextUser.setId(3L);
        Mockito.when(userAuthenticationContextServiceManager.getCurrentAuthentication()).thenReturn(contextUser);
        Assertions.assertThrows(TransactionException.class, () -> creditAccountTransactionServiceManager.transfer(transferTransaction));
    }
    ...
    public void transfer_validTransaction_success(){
        ...
        Mockito.when(accountEnvironment.getACCOUNT_TRANSACTION_MIN_AMOUNT()).thenReturn(1.0);
        Mockito.when(accountEnvironment.getACCOUNT_BALANCE_MAX_AMOUNT()).thenReturn(1_000_000_000.0);
        Mockito.when(accountEnvironment.getACCOUNT_CREDIT_START_BALANCE()).thenReturn(0.0);
        ...
        Assertions.assertNull(creditAccountTransactionServiceManager.transfer(transferTransaction));
    }
}
