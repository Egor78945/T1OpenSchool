...
public class DebitAccountTransactionServiceManager extends AbstractDebitAccountTransactionService<Transaction> {
    public DebitAccountTransactionServiceManager(@Qualifier("userAuthenticationContextServiceManager") AuthenticationContextService<User> userAuthenticationContextService, TransactionRepository transactionRepository, AccountRepository accountRepository, TransactionTypeRepository transactionTypeRepository, AccountEnvironment accountEnvironment, TransactionStatusRepository transactionStatusRepository) {
