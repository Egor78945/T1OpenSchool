...
import com.example.transaction_service.service.transaction.implementation.InsertTransactionProcessorServiceManager;
import com.example.transaction_service.service.transaction.implementation.TransferTransactionProcessorServiceManager;
...
@Service
public class TransactionProcessorServiceRouterManagement implements TransactionProcessorServiceRouter<Transaction, TransactionProcessorService<Transaction>> {
    private final Map<TransactionTypeEnumeration, TransactionProcessorService<Transaction>> transactionProcessorServiceMap;

    public TransactionProcessorServiceRouterManagement(InsertTransactionProcessorServiceManager insertTransactionProcessorServiceManager, TransferTransactionProcessorServiceManager transferTransactionProcessorServiceManager) {
    ...
    @Override
    public TransactionProcessorService<Transaction> getByTransactionType(TransactionTypeEnumeration transactionTypeEnumeration) {
