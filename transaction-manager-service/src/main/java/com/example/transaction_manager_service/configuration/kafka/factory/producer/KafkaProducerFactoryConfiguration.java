...
public class KafkaProducerFactoryConfiguration {
    ...
    public ProducerFactory<String, Transaction> transactionKafkaProducer(ObjectMapper objectMapper) {
        DefaultKafkaProducerFactory<String, Transaction> producerFactory = new DefaultKafkaProducerFactory<>(buildExactlyOnceProducerProperties(kafkaEnvironment.getKAFKA_TOPIC_TRANSACTION_RESULT_TRANSACTION_ID()));
